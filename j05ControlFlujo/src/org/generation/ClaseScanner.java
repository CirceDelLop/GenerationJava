...
public class ClaseScanner {
	...
	public static void main(String[] args) {
		/*La clase Scanner en Java se utiliza para leer datos de entrada de diferentes fuentes, como la consola, archivos o flujos de texto. Es especialmente útil para interactuar con el usuario mediante la consola. La clase Scanner en Java es una clase útil que se encuentra en el paquete java.util*/
		...
		/*Lee una línea completa de entrada como cadena de texto. Devuelve todo el texto de la línea, excluyendo el carácter de salto de línea(\n).
		 *Buffer: Memoria temporal donde se almacenan los datos de entrada antes de ser procesados.*/
		...
		/*Método next(): Se utiliza para leer una palabra desde la entrada. Detiene la lectura cuado encuentra un espacio, salto de línea o tabulación*/
		 ...
		 /*Se recomienda usar nextLine() adicional para capturar el salto de línea que quedó tras la entrada de nextLine()*/
