...
public class MathOperations
{
	 ...
	 *<modificadores_de_acceso> <tipo_retorno> nombreMétodo( parámetros ) <lista_de_excepciones> {// cuerpo del método }
	 ...
	 *Si el método no devuelve ningún valor(String, int, etc), se usa la palabra reservada "void".
	 *Nombre del método: Se recomienda comenzar el nombre con un verbo, Seguido por un adjetivo, sustantivo, etc. Usar la convención camelCase.
	 *Parámetros: Lista de parámetros separados por coma.
	 *La firma del método es como: nombreMétodo( double, int, double, double)*/
	...
	double sumarNumeros(double numA, double numB)
	{
		return numA+numB;
	}
	
	/**Sobrecarga de métodos (Method overload): Tener múltiples métodos con el mismo nombre, pero diferente lista de parámetros. Reglas:
	 * -El método debe tener el mismo nombre
	 * -Debe tener diferente orden en los tipos de parámdtros o números de parámetros
	 * -No se base en el tipo de retorno. Aunque pueda tener diferente tipo de retorno, se recomienda que sean de tipo compatible.
	...
	void imprimirResSumatoria(double resultado)
	{
		System.out.println("El resultado es: "+resultado);
		return;//Puede o no ponerse
	}
}
