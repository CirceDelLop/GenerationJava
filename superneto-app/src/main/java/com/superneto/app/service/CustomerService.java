...
/**Una interfaz es una declaración formal de un contrato, en la cuál los métodos no contienen implementaciones.
 *Es similar a los métodos abstractos.
 *Una clase puede implementar varias interfaces.
 *Las interfaces son adecuadas para proporcionar funcionalidad a clases que no están relacionadas entre si.
